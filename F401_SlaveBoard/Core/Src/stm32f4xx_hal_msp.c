...
void HAL_TIM_Encoder_MspInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  if(htim_encoder->Instance==TIM3)
  {
    ...
    PA7     ------> TIM3_CH2
    */
    GPIO_InitStruct.Pin = X_Enc1_Pin|X_Enc2_Pin;
  ...
  else if(htim_encoder->Instance==TIM4)
  {
    ...
    PB7     ------> TIM4_CH2
    */
    GPIO_InitStruct.Pin = Y_Enc1_Pin|Y_Enc2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  if(htim->Instance==TIM1)
  {
    ...
    PA9     ------> TIM1_CH2
    */
    GPIO_InitStruct.Pin = X_RPWM_Pin|X_LPWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  else if(htim->Instance==TIM2)
  {
    ...
    PA3     ------> TIM2_CH4
    */
    GPIO_InitStruct.Pin = Y_RPWM_Pin|Y_LPWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  if(htim_encoder->Instance==TIM3)
  {
    ...
    PA7     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(GPIOA, X_Enc1_Pin|X_Enc2_Pin);
  ...
  else if(htim_encoder->Instance==TIM4)
  {
    ...
    PB7     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(GPIOB, Y_Enc1_Pin|Y_Enc2_Pin);
